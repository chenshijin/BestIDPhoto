...
public class ROMTools {
    ...
    public static final String ROM_SMARTISAN = "SMARTISAN";//三星
    public static final String ROM_VIVO = "VIVO";//VIVO
    public static final String ROM_QIKU = "QIKU";//360手机
    ...
    public static boolean check(String rom) {
        try{
            if (sName != null) {
                Log.d(TAG, "当前系统"+sName+"   "+sName.equals(rom));
