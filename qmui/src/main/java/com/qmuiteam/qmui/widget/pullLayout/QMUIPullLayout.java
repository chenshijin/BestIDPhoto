...
//        PullAction action = getPullAction(mEnabledEdges);
//        if(action != null){
//            action.mIsActionRunning = false;
//            if(action.mActionView instanceof ActionPullWatcherView){
//                ((ActionPullWatcherView)action.mActionView).onActionFinished();
//            }
//            setVerOffsetToTargetOffsetHelper(300);
//            setHorOffsetToTargetOffsetHelper(300);
            mScroller.startScroll(0, 0, 0, dipToPx(getContext(),180F), 1000);//scrollDuration(mTopPullAction, 300)
            postInvalidateOnAnimation();
